    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <View style={styles.header}>
          <Text style={styles.title}>Resonate</Text>
        ...
        <View style={[styles.card, isRealtimeActive && styles.liveCard]}>
          ...
          <Text
            style={[styles.cardText, !realtimeResult && styles.placeholderText]}
          >
            {realtimeResult ||
        ...
        <Text style={styles.footerNote}>
          whisper.rn — download a model, try a sample file, or speak live.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
